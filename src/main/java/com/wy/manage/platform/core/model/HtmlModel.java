...
public class HtmlModel<T>  extends BasicModel<T>{
    ...
    public void defineAction() {
        ...
        defineAction(new SpanStartLineAction());
        defineAction(new SpanEndLineAction());
        defineAction(new SelectStartLineAction());
        defineAction(new SelectEndLineAciton());
        defineAction(new OptionEndLineAction());
        defineAction(new OptionStartLineAction());
    }
}
