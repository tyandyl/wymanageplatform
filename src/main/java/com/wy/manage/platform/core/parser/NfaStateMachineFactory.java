...
public class NfaStateMachineFactory {
    ...
    public static CharacterCarveCapacity getPlusCharacterCarveCapacity(){
        return new PlusCharacterCarveCapacity();
    }
    ...
    public static CharacterCarveCapacity getHtCharacterCarveCapacity(){
        return new HtCharacterCarveCapacity();
    }
}
