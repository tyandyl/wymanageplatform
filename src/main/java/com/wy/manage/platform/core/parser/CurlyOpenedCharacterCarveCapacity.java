 ...
 * Created by tianye
 */
public class CurlyOpenedCharacterCarveCapacity implements CharacterCarveCapacity{
        ...
        if(stack.empty()){
            ...
            if(specialCclStart.size()>0){
                ...
                if(peek.getMeanType()==MeanType.CHANGE_MEANING
                    ...
                    NfaStateMachine characterRepertoireNfaStateMachine = NfaManager.createCharacterRepertoireNfaStateMachine(nfaStateMachine,SymbolType.OPEN_CURLY.getState());
