 ...
 */
public class SpanStartLineAction extends BasicAction {
    ...
    public void action(ModelParam modelParam) throws Exception {
        ...
        if(t instanceof WidgetModel) {
            ...
            Widget widget = WidgetFactory.getWidget(model, s, value, TagType.SPAN);
//            String gbk = new String("控件设置".getBytes("utf-8"));
//            widget.setOutValue(gbk);
